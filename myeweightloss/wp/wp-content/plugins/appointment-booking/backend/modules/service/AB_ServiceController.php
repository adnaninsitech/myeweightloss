...
class AB_ServiceController extends AB_Controller
{
    ...
    public function executeUpdateService()
    {
        ...
        if ( empty( $staff_ids ) ) {
            ...
            AB_StaffService::query()->delete()->where( 'service_id', $service->id )->whereNotIn( 'staff_id', $staff_ids )->execute();
            ...
            $service_staff_exists = AB_StaffService::query()->select( 'staff_id' )->where( 'service_id', $service->id )->fetchArray();
            $service_staff = array();
