                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                            <div class="header-call">
                                <a href="tel:301.233.8590">Call <?php echo $options['phone_number']; ?></a>
                            </div>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link about-link" href="about.php">About Us</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link ser-link" href="services.php">Services</a>
                                </li>
                                <li class="nav-item">
...
<section class="inner-title <?php if(is_page(65)) {echo 'about-title'; } else if(is_page(73))  {echo 'services-title' ; } ?>">
    <div class="container">
        <div class="row">
