...
<section class="inner-title <?php if(is_page(65)) {echo 'about-title'; } else if(is_page(73))  {echo 'services-title' ; } else if(is_page(80)) {echo 'faqs-title' ;} else if(is_page(88)) {echo 'contact-title'; } ?>" style="background-image:url('<?php echo the_post_thumbnail_url(); ?>'); ">
    <div class="container">
        <div class="row">
